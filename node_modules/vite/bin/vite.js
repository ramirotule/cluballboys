#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/Users/ramirotule/.antigravity/extensions/wallabyjs.console-ninja-1.0.525-universal/out/buildHook/index.js').default({tool: 'vite', checkSum: '2016300f42d6e655d1fc76CRgDHgFWDlcHBQBXUwNQBlAHUVcA', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///Users/ramirotule/.antigravity/extensions/wallabyjs.console-ninja-1.0.525-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'vite', checkSum: '2016300f42d6e655d1fc76CRgDHgFWDlcHBQBXUwNQBlAHUVcA', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
